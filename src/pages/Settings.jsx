  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedUser = {
        ...
        store_name:
          response.data.user.store_name,

        owner_name:
          response.data.user.owner_name,

        email:
          response.data.user.email,  

        contact_number:
          response.data.user.contact_number,

        store_address:
          response.data.user.store_address,
      };
  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <CardHeader
          icon={
            <FaStore className="text-orange-500 text-[20px]" />
          }
      ...
      <Card>
        ...
        <CardHeader
          icon={
            <FiLock className="text-orange-500 text-[20px]" />
          }
      ...
      <Card>
        ...
        <CardHeader
          icon={
            <FiSettings className="text-orange-500 text-[20px]" />
          }
          title="Preferences"
